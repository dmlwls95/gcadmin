...
@Component({
  selector: 'app-charts-upload',
  templateUrl: './charts-upload.component.html',
  styleUrls: ['./charts-upload.component.scss']
})
export class ChartsUploadComponent {
  ...
  constructor( private fb: FormBuilder,
    ...
    onSubmit(files: FileList) {
      ...
      formData.append('editor', files[0]);
      ...
      // 폼데이터를 서버로 전송한다.
      this.http.post(`${apiurl}/gcUnit/upload/editor`, formData)
        .subscribe(res => {
          this.result = res;
          this.loading = false;
