...
@Component({
  selector: 'app-royalties-upload',
  templateUrl: './royalties-upload.component.html',
  styleUrls: ['./royalties-upload.component.scss']
})
export class RoyaltiesUploadComponent implements OnInit {
